...
:- begin_tests(raindrops).
    ...
    test(the_sound_for_3_is_pling, condition(true)) :-
        convert(3, Sounds),
        Sounds == "Pling".
    ...
    test(the_sound_for_6_is_pling_as_it_has_a_factor_3, condition(true)) :-
        convert(6, Sounds),
        Sounds == "Pling".
    ...
    test(the_sound_for_9_is_pling_as_it_has_a_factor_3, condition(true)) :-
        convert(9, Sounds),
        Sounds == "Pling".
    ...
    test(the_sound_for_27_is_pling_as_it_has_a_factor_3, condition(true)) :-
        convert(27, Sounds),
        Sounds == "Pling".

    test(the_sound_for_35_is_plangplong_as_it_has_factors_5_and_7, condition(true)) :-
        convert(35, Sounds),
        Sounds == "PlangPlong".
